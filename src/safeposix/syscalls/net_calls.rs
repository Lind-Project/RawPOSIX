...
*           will cause error in the future -- raw posix do the translation
...
impl Cage {
     ...
     *       - Fail: -1
     */
    pub fn recv_syscall(&self, virtual_fd: u64, buf: *mut c_void, len: usize, flags: i32) -> isize {
        let kernel_fd = translate_virtual_fd(self.cageid, virtual_fd).unwrap();
     ...
     */
    pub fn listen_syscall(&self, virtual_fd: u64, backlog: i32) -> i32 {
        let kernel_fd = translate_virtual_fd(self.cageid, virtual_fd).unwrap();
     ...
     */
    pub fn shutdown_syscall(&self, virtual_fd: u64, how: i32) -> i32 {
        let kernel_fd = translate_virtual_fd(self.cageid, virtual_fd).unwrap();
     ...
     */
    pub fn gethostname_syscall(&self, name: *mut i8, len: usize) -> i32 {
