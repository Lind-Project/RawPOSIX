...
struct EPollTable {
    highestneverusedentry: u64, // Never resets (even after close).  Used to
                                // let us quickly get an unused entry
    thisepolltable: HashMap<u64,HashMap<u64,interface::EpollEvent>>, // the epollentry ->
                                                           // virtfd ->
                                                           // event map
}
...
pub fn try_epoll_ctl(cageid:u64, epfd:u64, op:i32, virtfd:u64, event:interface::EpollEvent) -> Result<u64,threei::RetVal> {
...
pub fn get_epoll_wait_data(cageid:u64, epfd:u64) -> Result<HashMap<u64,interface::EpollEvent>,threei::RetVal> {
